  ...
  return (
    <div style={{margin: "100px"}}>
      ...
      <p>Cake It is a functioning e-commerce website for cakes. 
        ...
        <br/>
        Disclaimer the images and cake descriptions used in this website belongs to <a href="https://www.buttercakefactory.com/" target="_blank" rel="noopener noreferrer">The Buttercake Factory</a>.</p>
    </div>
  )
}
